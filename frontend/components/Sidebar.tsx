...
const navItems = [
  ...
  },
  {
    ...
    icon: ImageIcon,
    label: "Foto Editor",
    description: 'Bewerken & verwerken',
  },
  {
    href: '/ai',
    icon: Sparkles,
    label: 'AI Studio',
    description: 'Claude AI assistent',
  },
  {
    href: '/business',
    icon: BarChart3,
    label: 'Business',
    description: 'Inkomsten & bestellingen',
  },
  {
    href: '/settings',
    icon: Settings,
    label: 'Instellingen',
    description: 'API sleutels & voorkeur',
  },
]
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {isActive && (
                    <ChevronRight className="relative w-3.5 h-3.5 text-purple-400 flex-shrink-0" />
                  )}
                </Link>
              </motion.div>
            )
        ...
        <div className="mt-4 px-2">
          <div className="glass rounded-xl p-3">
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <span className="text-xs font-medium text-white/60">API Verbinding</span>
            </div>
            <p className="text-[10px] text-white/30 leading-relaxed">
              Backend actief op poort 8000
            </p>
          </div>
          <p className="text-center text-[10px] text-white/20 mt-3">
            FeetBusiness Studio © 2025
          </p>
        </div>
      </div>
    </aside>
